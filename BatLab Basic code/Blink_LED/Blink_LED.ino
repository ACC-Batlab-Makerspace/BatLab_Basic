...
Connect the negative side of your LED (shorter leg) to a 220 Ohm resistor (red-red-black-black). Connect the other side of the resistor to ground.
  
[We always use resistors between the Arduino and and LEDs to keep the LEDs from burning out due to too much current.]

This sketch was based on Circuit #1 from Sparkfun: https://learn.sparkfun.com/
