/*  RGB LED color mixing
    Make the RGB LED module display a rainbow of colors!
  
Hardware connections:
    
    Connect GND pin to Arduino GND.
    Connect RED to Arduino digital pin 9.
    Connect GREEN to Arduino digital pin 10.
    Connect BLUE (or "BLUR") to Arduino digital pin 11.
    
This sketch is a modification of Circuit #3 in the
the Sparkfun Inventor's Kit, written by SparkFun Electronics
